...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`Desert Bot- Script By : RED DIAMOND`);
        console.log(`----------------`);
      console.log(`ON ${client.guilds.size} Servers '     Script By : RED DIAMOND ' `);
    console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
client.user.setGame(` ABOWALEED ツ,"https://www.twitch.tv/abowaieed Shop")
                                ...
                                m.delete();
                                    message.channel.send(`:ballot_box_with_check: | Done ... The Broadcast Message Has Been Sent For ${message.guild.memberCount} Members`).then(msg => msg.delete(5000));
                                        message.guild.members.forEach(member => {
                                            ...
                                            .setTitle(":incoming_envelope: [BROADCAST FROM GLC™️] :incoming_envelope: ")
...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "help")) {
        let help = new Discord.RichEmbed()
            ...
            رابط سيرفر الدعم الفني : https://discord.gg/arePU7A
            **`);
